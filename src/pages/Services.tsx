...
const services = [
  ...
  },
  {
    icon: "Truck",
    title: "Доставка",
    desc: "Доставляем готовые детали по городу и области на следующий день после изготовления. Аккуратная упаковка в плёнку.",
    details: ["По городу", "В область", "Упаковка в плёнку", "На следующий день"],
    price: "от 500 ₽",
  },
];
...
const steps = [
  ...
  { num: "05", title: "Получение", desc: "Забираете самовывозом или заказываете доставку" },
];
